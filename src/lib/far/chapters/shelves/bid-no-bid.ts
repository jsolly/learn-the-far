...
export const BID_NO_BID_SHELF_CHAPTERS: Chapter[] = [
	...
	chapter({
		...
		summary: "Defines Pwin as a living, evidence-weighted judgment — not a CRM folklore number.",
		intro:
		...
		pieces: [
			{
				...
				teach:
					"A final-RFP re-gate is a mandatory control point when the final solicitation materially changes contract type, evaluation, transition, or schedule — refresh compliance, solution, price, Pwin, staffing, and economics, and be willing to no-bid. FAR 15.203 makes the solicitation the Government's request for proposals; draft assumptions do not survive by inertia. Treat final RFP drop with the same seriousness as the first investment gate.",
				watchFor:
			...
			},
			{
				...
				sourceUrl:
					"https://www.ecfr.gov/current/title-4/chapter-I/subchapter-B/part-21/section-21.2",
				sourceKind: "controlling-authority",
			},
		],
		furtherReading: [
