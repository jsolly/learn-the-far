		...
		pieces: [
			{
				...
				teach:
					"An acquisition stage is a distinct station in a federal buy: mission need and planning; market research and capability notices; a solicitation that requests offers or quotations; an award that creates a mutually binding relationship; orders or modifications that authorize specific work and funding; and performance that creates the record the next competition will read. At opportunity intake and at every gate, name the station you’re in, what evidence you have, and what still must happen before money and performance can move. If you cannot point to the operative instrument — notice, solicitation, contract, order, or modification — you are still upstream of that claim.",
				watchFor:
		...
		pieces: [
			{
				...
				teach:
					"The FAR is divided into parts, subparts, sections, and subsections. Digits left of the decimal are the part; digits right of the decimal identify subpart and section; numbers after a dash identify a subsection. Part 52 holds provision and clause text keyed to subject parts (see also FAR 52.101). This grammar tells a reader where to look — and whether you mean a prescription or the clause text itself.",
				watchFor:
			...
			},
			{
				...
				teach:
					"Agencies may issue acquisition regulations that implement or supplement the FAR. Your baseline for a civilian buy is usually the FAR plus that agency’s supplement (for example GSAM/GSAR or VAAR), plus any authorized deviation identified for the acquisition, plus the operative solicitation’s own terms. At opportunity kickoff, put four tabs in your binder: FAR, agency supplement, identified deviations, and the solicitation package as amended.",
				watchFor:
			...
			},
			{
				...
				teach:
					"A solicitation is any request to submit offers or quotations. A solicitation provision applies only before award. A contract clause is a term used in contracts, or in both solicitations and contracts, applying after award or both before and after award. When a negotiated solicitation uses the Uniform Contract Format, Section L typically carries instructions to offerors and Section M carries evaluation factors for award — that L/M split is a UCF mapping, not a universal label for every instrument. Some text dies at award; some text rides with you for years.",
				watchFor:
		...
		pieces: [
			{
				...
				teach:
					"Sources-sought notices and RFIs support market research and planning; RFI responses are not offers when the Government does not presently intend to award. An RFQ requests a quotation (and, depending on its terms, sometimes an offer). An RFP requests proposals in a negotiated acquisition. An IFB requests sealed bids evaluated without discussions. Classify the notice before staffing a response — wait for each document’s instructions before deciding whether the agency expects capability data, a quote, a proposal, or a bid.",
				watchFor:
	...
	chapter({
		...
		pieces: [
			...
			},
			{
				...
				teach:
					"A firm-fixed-price (FFP) contract provides a price that is not adjusted based on the contractor’s cost experience. It places maximum cost risk and full responsibility for profit or loss on the contractor, and it creates strong incentive to control costs. When pricing and capture argue about risk, place FFP on the fixed end of a spectrum of types — then name the actual type (or CLIN mix) in the solicitation before modeling margin.",
				watchFor:
	...
	chapter({
		...
		pieces: [
			...
			},
			{
				...
				teach:
					"CLINs and SLINs organize deliverables, pricing, accounting, funding, and performance periods. On an incrementally funded cost-reimbursement contract, the amount actually allotted — not the total estimated cost, ceiling, or option value — is the operative limit on paid and payable cost under the Limitation of Funds framework. Preserve total potential value, estimated cost, obligated/allotted funding, and the specific work each funded line covers as separate columns. Reconcile allotted funding to covered work and burn; stop or realign only on written CO funding direction.",
				watchFor:
	...
	chapter({
		...
		pieces: [
			...
			},
			{
				...
				teach:
					"Option exercise can extend performance when the CO follows the contract’s notice and exercise rules and finds funds, continued need, and advantage. Recompete planning backcasts from successor timing, PALT, and whether options or bridges are uncertainties — not certainties. Today’s performance file is tomorrow’s proposal volume and tomorrow’s responsibility record.",
				watchFor:
