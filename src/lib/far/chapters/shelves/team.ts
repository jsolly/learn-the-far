...
export const TEAM_SHELF_CHAPTERS: Chapter[] = [
	...
	chapter({
		...
		pieces: [
			...
			},
			{
				...
				teach:
					"Definite teaming terms are concrete, enforceable commitments in a teaming agreement or subcontract — scope, workshare, price, duration, termination, and exclusivity bounds — rather than promises to negotiate later. FAR 9.603 recognizes identified, fully disclosed contractor teams; it does not supply missing private terms or decide enforceability. Whether a teaming agreement or a particular promise is enforceable depends on governing state law and the agreement’s language. Material terms left for later “good-faith negotiation” often leave an agreement to agree, not a subcontract you can rely on in the proposal.",
				watchFor:
	...
	chapter({
		...
		intro:
			"Terms for whether the proposed offeror and teammates may bid this acquisition — size and status, set-aside path, teaming readiness, and affiliate-aware OCI.",
		tags: ["set-aside", "oci"],
		readingMinutes: 9,
		suggestedOrder: 3,
		pieces: [
	...
	chapter({
		...
		summary: "Defines LOS math and ostensible-subcontractor risk on set-aside teams.",
		intro:
		...
		pieces: [
			{
				...
				teach:
					"An individual small-business subcontracting plan is the contract-specific document required under FAR 19.704 when an unrestricted award triggers the plan requirement. It commits the company to goals by category, a description of the method used to develop those goals and to identify potential sources, efforts to ensure equitable opportunity, the name of an administrator, a description of records, and assurances on reporting and good-faith treatment of small businesses used in preparing the bid or proposal — among other required contents. It is an operational promise, not a capture artifact.",
				watchFor:
	...
	chapter({
		...
		pieces: [
			...
			},
			{
				...
				teach:
					"A post-award teammate change is a substitution, addition, or workshare shift among team members after contract award. Such changes must follow the solicitation, contract, and vehicle rules that govern disclosure and consent. The performance promise the Government bought — and the prime’s responsibility for it — remains unless the contract is properly modified. Map required flowdowns before first subcontract draft; identify consent and notification triggers in the prime and ordering vehicle; document teammate changes with the same disclosure discipline used pre-award.",
				watchFor:
