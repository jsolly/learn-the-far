		...
		pieces: [
			{
				...
				teach:
					"FAR 10.001 requires agencies to use market research to identify capable sources and determine whether small-business programs should be used. A sources-sought or similar market-research reply should supply specific, supportable evidence on scope integration, transition, capacity, commercial practices, and likely teaming — then plan for either prime or partner positioning. The response informs the agency’s decision file; it does not decide strategy. Answer each posted question with dated, supportable facts; address transition and subcontracting honestly; plan capture for set-aside and unrestricted outcomes.",
				watchFor:
