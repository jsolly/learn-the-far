...
import { FUNDAMENTALS_QUESTIONS } from "./fundamentals-questions";
...
export const QUESTIONS: QuizQuestion[] = [
	...FUNDAMENTALS_QUESTIONS,
	{
		...
		"options": [
			...
			{
				"id": "d",
				"text": "Only for awards above the simplified acquisition threshold.",
				"correct": false
			}
		],
	...
	},
	{
		...
		"explanation": "FAR 2.101 currently sets the baseline micro-purchase threshold at $15,000 and the simplified acquisition threshold at $350,000 (with listed exceptions). Older $10,000/$250,000 and $3,500/$150,000 figures are outdated — knowing the current numbers tells you which streamlined buying path a requirement can ride.",
		"citation": "FAR 2.101",
	...
	},
	{
		...
		"difficulty": "fundamentals",
		"scoring": "single-best",
		"prompt": "Which best describes a Governmentwide Acquisition Contract (GWAC), such as Alliant 3, NASA SEWP, or 8(a) STARS III?",
		"options": [
			{
				"id": "a",
		...
		"explanation": "FAR 2.101 defines a GWAC as a task-order or delivery-order contract for information technology, established by one agency for governmentwide use. Named vehicles like Alliant 3 (GSA), SEWP (NASA), and STARS III are the IDIQ lanes capture teams map pursuits onto — distinct from an agency-only IDIQ, a Schedule (MAS), or a BPA.",
		"citation": "FAR 2.101",
		"sourceUrl": "https://www.acquisition.gov/far/2.101",
		"tags": [
			"GWAC",
	...
	},
	{
		...
		"explanation": "FAR 19.702 requires a subcontracting plan when a contract with a large business is expected to exceed $900,000 ($2 million for construction) and has subcontracting possibilities. Small-business primes and set-asides are exempt; the SAT is a different (lower) threshold for simplified procedures.",
		"citation": "FAR 19.702",
