...
const questions: QuizQuestion[] = [
	{
		...
		situation:
			"For a negotiated civilian procurement, the solicitation requires a make-or-buy program. The lowest-cost 'buy' source is a proposed teammate whose advisory affiliate helped the agency develop closely related requirements and may hold nonpublic competitor information.",
		...
		options: [
			{
				...
				tier: "best",
				consequence:
					"The make-or-buy rationale is supportable and the apparently attractive source does not bypass an independent eligibility gate.",
			},
			{
				id: "b",
				...
				tier: "defensible",
				consequence:
					"You may give up some price advantage, but avoid building the proposal around an unresolved conflict.",
			},
			{
				id: "c",
				...
				tier: "disqualifying",
				consequence:
					"Make-or-buy review, consent, purchasing-system review, and OCI resolution are separate actions; one does not waive another.",
			},
			{
				id: "d",
	...
	},
	{
		...
		scoring: "tiered",
		situation:
			"On an unrestricted civilian opportunity, another large company proposes a 'joint venture' but wants your company alone to submit the offer, sign the contract, bear all Government performance risk, and issue it a subcontract after award.",
		...
		explanation:
			"FAR 9.601 distinguishes a partnership/JV acting as potential prime from a potential prime with subcontractors. FAR 9.603 recognizes arrangements when they are identified and relationships fully disclosed. Labels should match legal and operational reality; in a prime/sub team, your prime remains fully responsible to the Government under FAR 9.604(e).",
	...
	},
	{
		...
		scoring: "single-best",
		situation:
			"On a services set-aside, the small prime plans to retain 40% of receipts, pay 10% to a qualifying first-tier similarly situated entity, and pay 50% to your large company. The similarly situated entity plans to subcontract half of its share to your company.",
		...
		explanation:
			"The clause credits work performed by a first-tier similarly situated entity, but expressly says work that entity further subcontracts counts toward the prime's percentage that cannot be exceeded. From the large-sub seat, your direct and indirect shares must both be visible in the compliance model.",
	...
	},
	{
		...
		scoring: "tiered",
		situation:
			"For a general-construction contract above the simplified acquisition threshold that is totally set aside for small business, the proposed small prime will employ the project manager and superintendent, manage and supervise the project, oversee performance, and coordinate every trade. Excluding materials, it plans to pay 80% of the amount paid by the Government to large, non-similarly-situated trade subcontractors.",
	...
	},
	{
		...
		scoring: "single-best",
		situation:
			"Your large company sells commercial services to several civilian agencies. One contracting team asks how an approved commercial small-business subcontracting plan differs from an individual plan.",
	...
	},
	{
		...
		scoring: "single-best",
		situation:
			"Your large prime has an approved purchasing system after a successful CPSR. Its civilian prime contract includes FAR 52.244-2 and specifically lists one critical subcontract as requiring contracting-officer consent.",
	...
	},
	{
		...
		scoring: "reveal-tradeoff",
		situation:
			"After award of a civilian MAS CTA order, one member can no longer perform its assigned portion. The CTA lead proposes quietly replacing it with the lead's ordinary subcontractor and billing all work through the lead.",
		...
		options: [
			{
				...
				tier: "best",
				consequence:
					"The revised team remains transparent and each CTA member's prime responsibility and Schedule scope can be validated.",
			},
			{
				id: "b",
				...
				tier: "defensible",
				consequence:
					"Performance may pause, but the team avoids unilaterally changing the awarded contractor relationships.",
			},
			{
				id: "c",
				...
				tier: "disqualifying",
				consequence:
					"That treats a MAS CTA like a FAR 9.6 prime/sub team and can place work, rates, and responsibility outside the evaluated arrangement.",
			},
			{
				id: "d",
