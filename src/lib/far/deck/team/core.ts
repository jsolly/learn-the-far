...
const questions: QuizQuestion[] = [
	{
		...
		scoring: "single-best",
		situation:
			"Your large prime signed a two-page teaming agreement saying a specialist will receive 'approximately 35%' after award, while price, statement of work, duration, and termination remain subject to later good-faith negotiation. The agreement selects a state's law.",
		...
		options: [
			{
				...
				tier: "best",
				consequence:
					"The exchange is usable for capture while ownership, permitted use, access, and disposition are documented.",
			},
			{
				id: "b",
				...
				tier: "defensible",
				consequence:
					"You preserve confidentiality but may slow solution integration until the agreement is complete.",
			},
			{
				id: "c",
				...
				tier: "disqualifying",
				consequence:
					"The FAR does not create a blanket private NDA between teammates; you may lose practical control over valuable information.",
			},
			{
				id: "d",
				...
				tier: "costly",
				consequence:
					"A later proposal marking does not repair weak controls over material already disclosed to another company.",
			},
		],
		explanation:
	...
	},
	{
		...
		scoring: "tiered",
		situation:
			"A niche teammate wants your large prime to grant broad exclusivity across an entire civilian agency in exchange for an undefined workshare on one pursuit.",
	...
	},
	{
		...
		scoring: "tiered",
		situation:
			"Your large civilian prime wants meaningful work on a total small-business set-aside. The proposal window opens soon, and your company has an SBA-approved mentor-protege agreement with one qualified small protege but no pursuit-specific JV yet.",
		prompt:
			"Which valid path is usually fastest and lowest in execution risk for this near-term pursuit?",
		options: [
			{
				id: "a",
		...
		options: [
			{
				...
				tier: "best",
				consequence:
					"The concerns may be treated as joint venturers and affiliated for size, so capture should first bring the payment model into compliance and then reassess the relationship facts.",
			},
			{
				id: "b",
				...
				tier: "disqualifying",
				consequence:
					"Keeping one subcontract below 50% does not by itself prove full compliance with 13 CFR 125.6, which counts payments to all non-similarly-situated subcontractors; if the prime demonstrates full compliance, Bowhead's bright-line safe harbor applies.",
			},
			{
				id: "c",
				...
				tier: "costly",
				consequence:
					"A subcontracting plan does not address whether the small prime is actually dependent on a large subcontractor.",
			},
			{
				id: "d",
	...
	},
	{
		...
		scoring: "single-best",
		situation:
			"Your large prime is negotiating an individual small-business subcontracting plan for an unrestricted civilian contract. The plan requirement is already established; the team is deciding what the plan actually commits the company to do.",
	...
	},
	{
		...
		scoring: "single-best",
		situation:
			"Your large prime lacks one highly relevant reference. A proposed major subcontractor has excellent performance on nearly identical civilian work, and capture wants to present it as if it automatically becomes the prime's own record.",
	...
	},
	{
		...
		scoring: "reveal-tradeoff",
		situation:
			"Section L requires resumes and signed availability commitments for named key personnel. Two critical candidates are employees of your proposed subcontractor, which will not sign anything beyond the teaming agreement.",
		...
		options: [
			{
				...
				tier: "best",
				consequence:
					"The proposal supplies the required evidence and makes the teammate responsible for preserving the staffing commitment.",
			},
			{
				id: "b",
				...
				tier: "defensible",
				consequence:
					"You may lose some resume strength, but avoid submitting an unsupported mandatory commitment.",
			},
			{
				id: "c",
				...
				tier: "disqualifying",
				consequence:
					"The proposal omits required evidence; the agency evaluates the offer against the same stated instructions and factors.",
			},
			{
				id: "d",
				...
				tier: "costly",
				consequence:
					"The representation is unsupported and creates staffing, evaluation, and potential misrepresentation risk.",
			},
		],
		explanation:
			"There is no general exemption for subcontractor key personnel. In IT Objects, GAO sustained a protest because the awardee omitted a solicitation-required commitment letter for an individual supplied through a teammate; a teaming agreement containing no commitment was not a substitute. Follow the solicitation exactly, and separately bind the teammate to availability, notice, and replacement duties.",
	...
	},
	{
		...
		scoring: "tiered",
		situation:
			"Before locking your large-prime team, you learn that the teammate belongs to a corporate family with several advisory contracts at the target civilian agency. The teammate says only its own legal entity matters.",
		...
		explanation:
			"OCI analysis is fact-specific. FAR 9.505 supplies general rules, while FAR 9.504 requires the contracting officer to identify and evaluate potential OCIs as early as possible and avoid, neutralize, or mitigate significant potential conflicts before award. Corporate affiliation is neither an automatic safe harbor nor automatic exclusion; shared personnel, information, management, and contract roles must be surfaced so the contracting officer can make the determination.",
	...
	},
	{
		...
		scoring: "single-best",
		situation:
			"Your contracts lead is drafting a major commercial-services subcontract under a civilian prime contract and proposes copying every prime clause into it because 'our approved purchasing system covers consent anyway.'",
