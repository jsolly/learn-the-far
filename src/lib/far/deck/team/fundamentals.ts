...
const questions: QuizQuestion[] = [
	{
		...
		scoring: "single-best",
		prompt:
			"From a large civilian contractor's capture seat, which two structures does FAR 9.601 call contractor team arrangements?",
		options: [
			{
				id: "a",
		...
		explanation:
			"FAR 9.601 covers two forms: a partnership or joint venture acting as the potential prime, and a potential prime with proposed subcontractors for a specified contract or acquisition program. An SBA mentor-protege relationship may enable a qualifying JV, but it is not itself one of the FAR 9.601 forms.",
		citation: "FAR 9.601",
	...
	},
	{
		...
		scoring: "single-best",
		prompt:
			"Your large company will prime and a specialist will subcontract. Who is contractually accountable to the civilian agency for the team's performance?",
		options: [
			{
				id: "a",
		...
		explanation:
			"FAR 9.604(e) preserves the Government's right to hold the prime fully responsible regardless of its team arrangement. Naming or evaluating a subcontractor does not create a Government-subcontractor contract; the prime manages that relationship through its subcontract.",
	...
	},
	{
		...
		scoring: "single-best",
		prompt:
			"How is a GSA Multiple Award Schedule Contractor Team Arrangement different from your usual FAR 9.6 prime/sub team?",
		options: [
			{
				id: "a",
		...
		explanation:
			"GSA states that FAR subpart 9.6 does not apply to MAS CTA agreements. Every CTA participant must be a MAS contractor, remains an independent contractor, and operates as a prime for its own portion. A lead may coordinate invoicing and administration without becoming the sole prime over subcontractor members.",
	...
	},
	{
		...
		scoring: "single-best",
		prompt:
			"Your supplier-diversity lead labels every qualifying teammate simply 'small.' Which status map is accurate for capture and subcontracting-plan decisions?",
		options: [
			{
				id: "a",
	...
	},
	{
		...
		scoring: "single-best",
		situation:
			"A small-business prime asks your large company to perform most of the services on a total small-business set-aside. FAR 52.219-14 applies.",
