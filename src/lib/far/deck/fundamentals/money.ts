...
export const MONEY_FUNDAMENTALS: QuizQuestion[] = [
	{
		...
		tags: ["appropriation", "obligation", "expenditure", "outlay", "capture", "civilian-agency"],
	},
	{
		...
		tags: ["purpose-time-amount", "colors-of-money", "fiscal-law", "capture", "civilian-agency"],
	},
	{
		id: "fund-money-igce",
		unitId: "fundamentals",
		...
		tags: ["igce", "pricing", "price-analysis", "cost-analysis", "capture", "civilian-agency"],
	},
	{
	...
	},
	{
		...
		tags: ["q4", "year-end-spending", "bona-fide-needs", "proposal", "capture", "civilian-agency"],
	},
	{
	...
	},
	{
		...
		prompt: "Which number should govern near-term authorized cost and staffing decisions?",
		options: [
			{
				id: "a",
	...
	},
	{
		...
		citation: "FAR 32.704(a); FAR 52.232-22(c), (f); FAR 1.602-1(a); 31 U.S.C. § 1341(a)",
