...
export const CRAFT_FUNDAMENTALS: QuizQuestion[] = [
	{
		...
		scoring: "single-best",
		prompt:
			"In disciplined capture management, what is probability of win (Pwin) primarily used for?",
		options: [
			{
				id: "a",
	...
	},
	{
		...
		prompt:
			"Which revision best turns the raw strength into a supported discriminator and customer-focused win theme while using supported indirect competitive positioning?",
		options: [
			{
				id: "a",
